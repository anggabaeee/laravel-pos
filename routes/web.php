...
Route::get('/setting/edituserupdate/{id}', 'PosController@edituserupdate');
Route::get('/setting/ChangePassword/{id}', 'PosController@changepassword');
Route::get('/changepasswordupdate/{id}', 'PosController@changepasswordupdate');
