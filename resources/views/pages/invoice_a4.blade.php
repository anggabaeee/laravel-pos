            ...
            <div id="printdiv" name="printdiv">
                ...
                <div class="row">
                    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000; border-collapse: collapse;">
                        <thead>
                            <tr>
                                <th style="text-align:center; padding-top: 5px; border-bottom:1px solid #000" width="10%"><em>#</em></th>
                                <th style="text-align:left; padding-top: 5px; border-bottom:1px solid #000" width="35%" align="left">Products</th>
                                <th style="text-align:center; padding-top: 5px; border-bottom:1px solid #000" width="10%">Qty</th>
                                <th style="text-align:center; padding-top: 5px; border-bottom:1px solid #000" width="25%">Per Item</th>
                                <th style="text-align:center; padding-top: 5px; border-bottom:1px solid #000" width="20%" align="right">Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php $n=1 @endphp
