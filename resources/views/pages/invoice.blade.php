...
<div class="container">
    <div id="wrapper">
        ...
        <div class="row" style="margin-top: 10px"><strong style="font-size: 24px">{{$outlets->name_outlet}}</strong></div>
            ...
            <table class="table" cellspacing="0" border="0">
                ...
                @foreach($items as $i) 
                    <tr>
                        ...
                        <td style="text-align:left; width:130px;">{{$i->product_name}} <br> [{{$i->product_code}}]</td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2"
                            ...
                            Amount</td>
                        <td colspan="2"
                            style="text-align:right; font-weight:bold; padding-top: 5px; padding-bottom: 5px;">{{$orders->paid_amt}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2"
                            style="text-align:left; font-weight:bold; padding-top: 5px; padding-bottom: 5px;">Return Change</td>
                        <td colspan="2"
                            style="text-align:right; font-weight:bold; padding-top: 5px; padding-bottom: 5px;">{{$orders->return_change}}
                        </td>
                    </tr>
                    @endif
                    <tr>
        ...
        <div class="row" style="border-top:1px solid #000; padding-top:0px;">
        ...
        <div class="row">
            <a href="#"
                style="width:100%; display:block; font-size:13px; text-decoration: none; text-align:center; color:#000; background-color:#4FA950; border:0px solid #4FA950; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;">Print A4
            </a>
        </div>
    </div>
</div>
